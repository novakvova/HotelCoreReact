...
namespace WebSiteCore.Migrations
{
    ...
    [Migration("20190325080725_Add sqlView vApartmentData")]
    partial class AddsqlViewvApartmentData
    {
            ...
            modelBuilder.Entity("WebSiteCore.DAL.Entities.Offer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Description = "Great offer in CITYHOTEL! 15% OFF for accommodation on weekdays!", From = new DateTime(2019, 3, 20, 11, 17, 17, 720, DateTimeKind.Local), ImageName = "SpringWeekdays_1", Name = "Spring Weekdays", To = new DateTime(2019, 5, 19, 11, 17, 17, 720, DateTimeKind.Local) },
                        new { Id = 2, Description = "Your discount on weekends (Fri - Sun): 1 day 15% OFF; 2-3 days 25% OFF", From = new DateTime(2019, 3, 20, 11, 17, 17, 720, DateTimeKind.Local), ImageName = "FriSatSun_1", Name = "FriSatSun", To = new DateTime(2019, 7, 18, 11, 17, 17, 720, DateTimeKind.Local) },
                        new { Id = 3, Description = "Book at our website and get an additional 5% discount of the Best Available Rate - Extra 5% OFF", From = new DateTime(2019, 3, 20, 11, 17, 17, 720, DateTimeKind.Local), ImageName = "BookAtSite_1", Name = "Book at out website", To = new DateTime(2020, 3, 14, 11, 17, 17, 720, DateTimeKind.Local) }
                    );
                });
